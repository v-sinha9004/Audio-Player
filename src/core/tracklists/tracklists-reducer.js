...
import { INITIAL_TRACKLIST_ID } from 'src/core/constants';
...
export const initialState = new Map({
  currentTracklistId: 'INITIAL_TRACKLIST_ID',
  [INITIAL_TRACKLIST_ID]: new Tracklist({id: INITIAL_TRACKLIST_ID, isNew: false})
});
